...
public class PlayerIsraDynameEntity extends GolemEntity {
    ...
    public PlayerIsraDynameEntity(EntityType<? extends GolemEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new PlayerIsraDynameEntity.AttackGoal(this));
        this.goalSelector.addGoal(2, new ApproachTargetGoal(this, 0.9D, 64.0F));
        this.goalSelector.addGoal(3, new LookAtGoal(this, PlayerEntity.class, 6.0F));
        this.goalSelector.addGoal(4, new LookRandomlyGoal(this));
        this.targetSelector.addGoal(1, new HurtByTargetGoal(this, PlayerEntity.class, PlayerIsraDynameEntity.class));
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, MobEntity.class, 5, false, false, (p_234199_0_) -> {
            return p_234199_0_ instanceof IMob && !(p_234199_0_ instanceof PlayerIsraDynameEntity);
        }));
    }
    ...
    static class AttackGoal extends Goal {
        private final PlayerIsraDynameEntity israDyname;
        private int tickCounter;

        public AttackGoal(PlayerIsraDynameEntity israDyname) {
